require("presence"):setup({
    ...
    file_explorer_text  = "Browsing a codebase",        -- Format string rendered when browsing a file explorer (either string or function(file_explorer_name: string): string)
